...
export const IconTerminal = ({ size, className, title }: IconProps) => (
  <svg {...base(size, 2)} className={className} aria-label={title}>
    <title>{title}</title>
...
export const IconSearch = ({ size, className, title }: IconProps) => (
  <svg {...base(size, 2)} className={className} aria-label={title}>
    <title>{title}</title>
...
export const IconBrowser = ({ size, className, title }: IconProps) => (
  <svg {...base(size, 2)} className={className} aria-label={title}>
    <title>{title}</title>
...
export const IconCode = ({ size, className, title }: IconProps) => (
  <svg {...base(size, 2)} className={className} aria-label={title}>
    <title>{title}</title>
...
export const IconTool = ({ size, className, title }: IconProps) => (
  <svg {...base(size, 2)} className={className} aria-label={title}>
    <title>{title}</title>
